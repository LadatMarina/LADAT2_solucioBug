...
public class Snake : MonoBehaviour
{
    ...
    //varianble per colocar a nes puesto dsprés
    ...
    private class SnakeBodyPart
    {
        ...
        /// FUNCIÓ SNAKE BODY PART
        ///  És una funció qe s'emplearà amb es constructor.
        ///  1. crea una nova body part
        ///  2. li posa sprite renderer 
        ///  3. li posa sa foto 
        ///  4. coloca per davall de sa colita que ja hi ha amb ses sorting layers
        ///  5. asigna sa posició de sa body part a una variable d'aquest script anomenada transform
        /// <param name="bodyIndex"> li ficam es número de s'ordre en que està per posar-lo per davall de sa anterior colita
        ...
        /// FUNCIÓ SET MOVE POSITION
        /// 1. guarda dins sa variable d'aquest script "snakeMovePosition" sa variable que li ficam a sa funció SetMovePo
        /// </summary>
        /// <param name="snakeMovePosition"></param>
